            ...
            <div className="row gy-5">
               ...
               <div className="col-lg-7 col-xl-8 text-center text-lg-start">
                  ...
                  <p className={darkTheme ? "text-white-50" : ""}>
                     ...
                     business as well as their customers. I believe the key to success is continous
                     learning and I'm excited about the opportunites to further my skills and
               ...
               <div className="col-lg-5 col-xl-4">
                  <div className="ps-lg-4">
                     <ul
                        className={
                           "list-style-2 " + (darkTheme ? "list-style-light text-light" : "")
                        }
                     >
                        <li>
